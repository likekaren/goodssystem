...
<script type="text/javascript">
	...
	function toqueryprocedurecoding() {
		if (parent.parent.parent) {
			//让第二层页面执行跳转
			parent.location = '${baseurl}procedurecoding/queryprocedurecoding.action?pc=punch';
		}
	}
		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState == 4){
				if(xhr.status == 200){
					...
					if (a!=null&&a!="") {
						$("#cut").append(a+"</td><td width=‘120’>"+"<input readonly='readonly' style='border:0'  type='text' name='procedurecodingCustom.pc' value=冲压>"+"</td><td width=‘120’>"+"<input readonly='readonly' style='border:0'  type='text' name='procedurecodingCustom.countnum' value=1>"+"</td><td width=‘120’>"+"<input readonly='readonly' style='border:0'  type='text' name='procedurecodingCustom.finishtime' value="+"\""+tt+"\""+"/>"+"</td>"+"<td width=‘120’>"+"<input readonly='readonly' style='border:0'  type='text' name='procedurecodingCustom.operator' value="+"\""+name+"\""+"/>"+"<td width=‘120’><input type='button' value='删除' onclick='deleteRow(this)'></td>"+"</tr>");
	...
	function procedurecodingadd(){
		if (a!=null&&a!="") {
			$("#cut").append(a+"</td><td>"+"<input readonly='readonly' style='border:0'  type='text' name='procedurecodingCustom.pc' value=冲压>"+"</td><td>"+"<input readonly='readonly' style='border:0'  type='text' name='procedurecodingCustom.countnum' value=1>"+"</td><td>"+"<input readonly='readonly' style='border:0'  type='text' name='procedurecodingCustom.finishtime' value="+"\""+tt+"\""+"/>"+"</td>"+"<td>"+"<input readonly='readonly' style='border:0'  type='text' name='procedurecodingCustom.operator' value="+"\""+name+"\""+"/>"+"<td><input type='button' value='删除' onclick='deleteRow(this)'></td>"+"</tr>");
		}
	}
