...
<script type="text/javascript">
	function equipmentledgersave() {
		...
		//第一个参数：form的id
		//第二个参数：equipmentledgersave_callback是回调函数，equipmentledgersave_callback当成一个方法的指针
		//第三个参数：传入的参数， 可以为空
...
<body>
	<form id="equipmentledgerform" action="${baseurl}equipmentledger/addequipmentledgersubmit.action"
		method="post">
		<!-- 更新在制品的id -->
			...
			<table cellpadding="5">
				...
				<tr>
					<td colspan=4 align=right class=category><a id="submitbtn"
						...
						iconCls="icon-ok" href="#" onclick="equipmentledgersave()">保存</a> <a
